                    ...
                    <table class="table table-responsive table-bordered" id="profiletable">                                            
                        <tbody>
                            <tr>
                                ...
                                <td><span id="getCompanyName"><?php echo $company_name; ?></span><span id="getTotalUsers"></span></td>
                            </tr>
                            <tr>
                                <td><b>Address</b></td>
                                <td id="getCompanyAddress" style='width:100%'><?php echo $Address; ?></td>
                            </tr>
                            <tr>
                                <td><b>Phone No.</b></td>
                                <td id="getCompanyNo"><?php echo $Contact; ?></td>
                            </tr>
                            <tr>
                                <td><b>Currency</b></td>
                                <td id="getCompanyCurrency"><?php echo $currency; ?></td>
                            </tr>
                            <tr>
                                <td><b>Merchandise</b></td>
                                <td id="getCompanyType"><?php echo $business_type; ?></td>
                            </tr>
                            <tr>
                                <td><b>Item Details</b></td>
                                <td><span id="getTotalItems"></span> <span id="getTotalCategory"></span> <span id="getTotalWarehouse"></span></td>
                            </tr>
                            <tr>
                                <td><b>Inventory</b></td>
                                <td><span id="getTotalProducts"></span> <span id="getTotalPaidOrders"></span> <span id="getTotalUnpaidOrders"></span></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
