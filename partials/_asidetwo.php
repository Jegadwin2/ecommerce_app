    ...
    <div class="sidebar close-sidebar">
        <ul class="sidebar-list">
            ...
            <li class="dropdown">
                ...
                <div class="submenu">
                    <a href="homepage.php?suppliers" class="<?php if($path == "suppliers"){echo "link active";}else{echo "link";}?>">
            ...
            <li class="dropdown">
                <div class="title">
                    <a href="homepage.php?postransactions" class="<?php if($path == "postransaction"){echo "link active";}else{echo "link";}?>">
