        ...
        <main class="full-width">
            ...
            <div class="recent-orders">
                ...
                <div class="tableoverflow">
                    <table id="datatableid" class="custtable">
                        <thead>
                            <tr>
                                <?php
                                    if (isset($_GET['error'])) {
                                        echo "<div class='alert alert-danger'>
                                                <span class='glyphicon glyphicon-info-sign'></span> &nbsp; <p></p><b>Customer Not Saved</b><p></p>
                                            </div>";
                                    }
                                    if (isset($_GET['success'])) {
                                        echo "<div class='alert alert-success'>
                                                <span class='glyphicon glyphicon-info-sign'></span> &nbsp; <p></p><b>Customer Successfully Added ! </b><p></p>
                                            </div>";
                                    }
                                ?>                                
                ...
                <a href="#" id="add_customer">Add Customer</a>
            </div>
    ...
    <div id="mainContent">
        <div id="box">
            <div class="boxes bx2" id="boxes">
                <h2 class='enter_cust'>Enter Customer Details</h2>
                <form class="add_customer form" id="form">
                    <input class="first" type="text" name="cust_code" disabled id="cust_code" value="<?php echo $cus_id ?>">
                    <input class="first" type="text" name="cust_name" id="cust_name" placeholder="Enter Customer Name">
                    <input class="first" type="text" name="contact_no" id="contact_no" placeholder="Enter Customer Contact">
                    <select class="form-control" id="gender" name="gender" required>
                        <option selected disabled>Select Gender</option>
                        <option value="Male">Male</option>
                        <option value="Female">Female</option>
                    </select>
                    <input class="first" type="date" name="date" id="date" placeholder="Select Date">
