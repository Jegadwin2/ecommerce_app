...
<html lang="en">
    ...
    <body>
        ...
        <section class="shop" id="shop">
            <div class="container">
                <div class="box">
                    <img src="assets/img/products/irishcoffee.jpg" alt="">
                    <h4>I'm a product</h4>
                    <h5>$15.00</h5>
                    <div class="cart">
        ...
        <section class="contact" id="contact">
            <div class="main-contact">
                ...
                <div class="contact-content">
                    ...
                    <li><a href="#">Tel: +(234) 8099568712</a></li>
                </div>
        ...
        <div class="last">
            <p>&#169; 2023 by MySS. Proudly created by MySS</p>
        </div>

        <?php require_once("partials/_fullscript.php"); ?>
