...
<body>
    ...
    <div style="display:none"><?php echo $staff_id; ?></div>
    <div style="display:none"><?php echo $page_theme; ?></div>
    <div class="container">
        ...
        <main>
            ...
            <div class="recent-orders">
                <form id="add_product" role="form" enctype="multipart/form-data">
                    <h2>Add Product</h2>
                    <table id="datatableid">
                            ...
                            <?php
                                if (isset($_GET['error'])) {
                                    echo "<div class='alert alert-danger'>
                                            <span class='glyphicon glyphicon-info-sign'></span> &nbsp; Product Not Saved
                                        </div>";
                                }
                                if (isset($_GET['success'])) {
                                    echo "<div class='alert alert-success'>
                                            <span class='glyphicon glyphicon-info-sign'></span> &nbsp; Product Successfully Added !
                                        </div>";
                                }
                            ?>                                
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" id="prod_price" class="form-control" value="">
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                ...
                                <select class="form-control" id="availablility" name="availablility" required>
                            ...
                            <td id="add_desc">
                                ...
                                <textarea rows="5" id="prod_desc" class="form-control" value=""></textarea>
                            </td>
                            <td>
